<template>
  <div class="footer-container">
    ...
    <div class="copyright">
      <div>备案号：<a href="https://beian.miit.gov.cn/" color-green-500>蜀ICP备15023364号-2</a></div>
      <div>Copyright © 2020-present 滴滴出行</div>
    </div>
  </div>
</template>

<script setup lang="ts">
import Popover from '@theme/components/Popover.vue'
